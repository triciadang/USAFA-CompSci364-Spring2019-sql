...
SELECT LGEMPLOYEE.EMP_NUM, LGEMPLOYEE.EMP_FNAME, LGEMPLOYEE.EMP_LNAME, MAX(LGSALARY_HISTORY.SAL_AMOUNT) AS largestsalary
...
ORDER BY largestsalary DESC, LGEMPLOYEE.EMP_NUM ASC;